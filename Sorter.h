...
class SorterComplexType	{
	public:
		...
		static bool quicksort(std::vector<Vector3f > &array, int bottom, int top, int element, std::vector<R> *helper_array=0x00)	{
			// uses recursion-the process of calling itself
			int middle;
			if(bottom<top)	   {
...
// partitions the array and returns the middle index (subscript)
		static int partitionArray(std::vector<Vector3f > &array, int bottom, int top, int element, std::vector<R> *helper_array=0x00)	{
